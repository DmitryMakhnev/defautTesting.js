...
describe('defaultTesting.utils.createTag()', function () {

    it('correct define', function () {
        expect(defaultTesting.utils.createTag).toBeDefined();
    });

    var createTag = defaultTesting.utils.createTag;
    ...
    describe('without content tags list', function () {
        cycle(['input', 'img', 'br', 'hr', 'link', 'meta'], function (tagName) {
            it('<' + tagName + ' />', function () {
